				...
				<div class="row">
					<div class="col-sm-6">
						...
						<div class="form-block">
							...
							<input type="email" id="email" required placeholder="it@gmail.com">
						</div>
						...
						<div class="your-order">
							...
							<div class="your-order-body" style="padding: 0px 10px">
								<div class="your-order-item">
									...
									<!--  one item	 -->
										<div class="media">
											<img width="25%" src="assets/dest/images/sanpham1.jpg" width="100" alt="" class="pull-left">
											<div class="media-body">
												<p class="font-large">Vivo S9</p>
												<span class="color-gray your-order-info">Màu: Xanh</span>
								...
								<div class="your-order-item">
									...
									<div class="pull-right"><h5 class="color-black">5.000.000₫</h5></div>
									<div class="clearfix"></div>
								</div>
							</div>
