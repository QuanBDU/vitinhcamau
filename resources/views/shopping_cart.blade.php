		...
		<div id="content">
					...
					<tbody>
						...
						<tr class="cart_item">
							<td class="product-name">
								<div class="media">
									<img class="pull-left" src="assets/dest/images/sanpham1.jpg" width="100" alt="">
									<div class="media-body">
										<p class="font-large table-title">Vivo S9</p>
										<p class="table-option">Màu: Đỏ</p>
							...
							<td class="product-remove">
								<a href="#" class="remove" title="Xóa sản phẩm này"><i class="fa fa-trash-o"></i></a>
							</td>
						</tr>
					</tbody>
						...
						<tr>
							<td colspan="6" class="actions">
								...
								<div class="coupon">
									...
									<button type="submit" class="beta-btn primary" name="apply_coupon">Áp dụng phiếu giảm giá <i class="fa fa-chevron-right"></i></button>
								</div>
								
								<button type="submit" class="beta-btn primary" name="update_cart">Cập nhật giở hàng <i class="fa fa-chevron-right"></i></button> 
								<button type="submit" class="beta-btn primary" name="proceed">Tiến hành kiểm tra <i class="fa fa-chevron-right"></i></button>
							</td>
						</tr>
					</tfoot>
				</table>
			...
			<div class="cart-collaterals">
				...
				<form class="shipping_calculator pull-left" action="#" method="post">
					<h2><a href="#" class="shipping-calculator-button">Tính toán vận chuyển <span>↓</span></a></h2>
				...
				<div class="cart-totals pull-right">
					...
					<div class="cart-totals-row"><span>Tổng:</span> <span>5.000.000₫</span></div>
					<div class="cart-totals-row"><span>Vận chuyển:</span> <span>Miễn phí vận chuyển</span></div>
					<div class="cart-totals-row"><span>Tổng đơn:</span> <span>5.000.000₫</span></div>
				</div>
